                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="StandardSignupPoint">{{ val.standardSignupPoint }}</td>
                            <td class="whitespace-nowrap" label="KtSignupPoint">{{ val.ktSignupPoint }}</td>
                            <td class="whitespace-nowrap" label="Amount">{{ val.amount }}</td>
                            <td class="whitespace-nowrap" label="UsedAt">{{ val.usedAt }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Number label="StandardSignupPoint" v-model="selectedRow.standardSignupPoint" :editMode="true"/>
                            <Number label="KtSignupPoint" v-model="selectedRow.ktSignupPoint" :editMode="true"/>
                            <Number label="Amount" v-model="selectedRow.amount" :editMode="true"/>
                            <Date label="UsedAt" v-model="selectedRow.usedAt" :editMode="true"/>
